...
return [
    ...
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'Darscrubs_Customization' => 1,
        'Dotdigitalgroup_Email' => 1,
        'Dotdigitalgroup_Chat' => 1,
        'Dotdigitalgroup_B2b' => 1,
        'Dotdigitalgroup_Enterprise' => 1,
        'Ebizmarts_MailChimp' => 1,
        'Emizentech_Revelup' => 1,
        'Emizentech_RevelupWebHook' => 1,
        'Fastly_Cdn' => 1,
        'Firebear_ImportExport' => 1,
        'Firebear_Darscrubs' => 1,
        'Klarna_Core' => 1,
        'Klarna_Ordermanagement' => 1,
        'Klarna_Kp' => 1,
        'Klarna_Onsitemessaging' => 1,
        'Klarna_KpGraphQl' => 1,
        'Messagebird_Integration' => 1,
